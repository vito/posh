...
func (p *Posh) Init() {
	...
	rules = [...]func() bool{
		...
		/* 21 Reference <- <(([a-z] / [A-Z] / [0-9] / '_')+ ('.' ([a-z] / [A-Z] / [0-9] / '_')+)*)> */
		func() bool {
